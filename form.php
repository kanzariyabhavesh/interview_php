...
include 'conn.php';
if (isset($_GET['edit'])) {
       $sql = "SELECT * FROM  `form_data` where `id` = $_GET[id]";
  ...
  <center>
    ...
    <table border="10px">
      ...
      <tbody>
        ...
        <td>".$row['Marks']."</td>
        <td>
        <button><a href='form.php?edit=edit&id=$row[id]'>Edit</a></button>
    ...
    <br>
    <button><a href='form.php'>New Record</a></button>
